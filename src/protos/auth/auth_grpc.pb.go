...
func (c *authClient) Login(ctx context.Context, in *User, opts ...grpc.CallOption) (*LoginResponse, error) {
...
func (UnimplementedAuthServer) Login(context.Context, *User) (*LoginResponse, error) {
